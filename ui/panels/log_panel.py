...
class LogPanel(QWidget):
    ...
    def _append_live_entry(self, entry: Dict[str, str]):
        ...
        if source not in self._source_names:
            ...
            self.source_combo.addItems(self.available_sources())
            self.source_combo.setCurrentText(
                current_source if current_source in self.available_sources() else "Tum kaynaklar"
            )
    ...
    def _append_row(self, entry: Dict[str, str]):
