...
TOK_THEME_VARIANTS = {
    "light": {
        ...
        "palette": {
            ...
            "BORDER": "#d4dce6",
            "HOVER": "#6ba5f7",
            "STATUS_ONAY_BG": "#d4edda",
            "STATUS_ONAY_TEXT": "#155724",
            "STATUS_NOTLU_BG": "#fff3cd",
            "STATUS_NOTLU_TEXT": "#856404",
            "STATUS_RED_BG": "#f8d7da",
            "STATUS_RED_TEXT": "#721c24",
        },
    },
    "dark": {
        "label": "Gece Mavisi",
        ...
        "palette": {
            ...
            "BORDER": "#3a4555",
            "HOVER": "#6ba5f7",
            "STATUS_ONAY_BG": "#1b4332",
            "STATUS_ONAY_TEXT": "#d8f3dc",
            "STATUS_NOTLU_BG": "#5d4037",
            "STATUS_NOTLU_TEXT": "#ffecb3",
            "STATUS_RED_BG": "#641e16",
            "STATUS_RED_TEXT": "#f9ebea",
        },
    },
    "sand": {
        "label": "Gundogumu",
        ...
        "palette": {
            ...
            "BORDER": "#e4d3c2",
            "HOVER": "#d98142",
            "STATUS_ONAY_BG": "#e2ece9",
            "STATUS_ONAY_TEXT": "#1a4d44",
            "STATUS_NOTLU_BG": "#fcf3cf",
            "STATUS_NOTLU_TEXT": "#7d6608",
            "STATUS_RED_BG": "#fadbd8",
            "STATUS_RED_TEXT": "#78281f",
        },
    },
    "forest": {
        "label": "Cam Yesili",
        ...
        "palette": {
            ...
            "BORDER": "#d5e2db",
            "HOVER": "#3d9270",
            "STATUS_ONAY_BG": "#d5e8d4",
            "STATUS_ONAY_TEXT": "#004d00",
            "STATUS_NOTLU_BG": "#fff2cc",
            "STATUS_NOTLU_TEXT": "#664d00",
            "STATUS_RED_BG": "#f8cecc",
            "STATUS_RED_TEXT": "#660000",
        },
    },
    "steel": {
        "label": "Celik Gri",
        ...
        "palette": {
            ...
            "BORDER": "#d4dbe4",
            "HOVER": "#5a7da0",
            "STATUS_ONAY_BG": "#e1f5fe",
            "STATUS_ONAY_TEXT": "#01579b",
            "STATUS_NOTLU_BG": "#fff9c4",
            "STATUS_NOTLU_TEXT": "#fbc02d",
...
def _resolve_variant_tokens(variant: str):
    ...
    tokens = {
        ...
        "BG_LIGHT": bg_light,
        "PRIMARY": primary,
        "STATUS_ONAY_BG": palette["STATUS_ONAY_BG"],
        "STATUS_ONAY_TEXT": palette["STATUS_ONAY_TEXT"],
        "STATUS_NOTLU_BG": palette["STATUS_NOTLU_BG"],
        "STATUS_NOTLU_TEXT": palette["STATUS_NOTLU_TEXT"],
        "STATUS_RED_BG": palette["STATUS_RED_BG"],
        "STATUS_RED_TEXT": palette["STATUS_RED_TEXT"],
    }
