...
def _load_last_db() -> str:
    ...
    # 3) Çalışma dizini ve exe dizinindeki varsayılan dosya
    candidate_paths.append("projeler.db")
    try:
        from app_paths import get_app_base_dir
        candidate_paths.append(os.path.join(get_app_base_dir(), "projeler.db"))
    except Exception:
        pass
    ...
    return os.path.abspath("projeler.db")
